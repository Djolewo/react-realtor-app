        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          <form onSubmit={onSubmit}>
            ...
            <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
              <p className='mb-6'>Don't have a account?<Link to="/sign-up" className='text-red-600 hover:text-blue-600 transition duration-200 ease-in-out ml-1'>Register</Link></p>
              <p>
